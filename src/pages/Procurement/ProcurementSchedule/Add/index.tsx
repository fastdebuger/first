 ...
 * @constructor
 */
const PurchaseStrategyScheduleAdd: React.FC<any> = (props) => {
    ...
    <CrudAddModal
      ...
      onCommit={(values: any) => {
        return new Promise((resolve) => {
          dispatch({
            type: "purchaseStrategySchedule/addPurchaseStrategySchedule",
            payload: values,
            callback: (res: any) => {
              resolve(true);
...
export default connect()(PurchaseStrategyScheduleAdd);
