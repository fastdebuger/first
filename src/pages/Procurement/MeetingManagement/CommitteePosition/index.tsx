 ...
 * @constructor
 */
const PositionPage: React.FC<any> = (props) => {
  ...
  const getTableColumns = () => {
    ...
    cols.initTableColumns([
      ...
      .setTableColumnToDatePicker([
        { value: 'create_time', valueType: 'dateTs', format: 'YYYY-MM-DD' },
      ])
      .needToExport([
        "dep_name",
        "position_code",
  ...
  return (
    <div>
      <BaseCurdSingleTable
        cRef={actionRef}
        rowKey="id"
        tableTitle='委员会职务档案信息'
        type="position/getPosition"
        exportType="position/getPosition"
        tableColumns={getTableColumns()}
        funcCode={authority + '委员会职务档案信息'}
        tableSortOrder={{ sort: 'create_time', order: 'desc' }}
...
export default connect()(PositionPage);
