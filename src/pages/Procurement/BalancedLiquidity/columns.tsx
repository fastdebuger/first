...
export const configColumns = [
  ...
  {
    title: 'material.if_balance_inventory',
    subTitle: '是否平衡',
    dataIndex: 'if_balance_inventory',
    width: 160,
    align: 'center',
    render: (str: string) => {
      const isFlag = String(str) === "1"
      const isText = isFlag ? "已平衡" : "未平衡";
      const isColor = isFlag ? "success" : "error";
      return <Tag color={isColor}>{isText}</Tag>
    }
  },
];
