...
const OverallsAdd: React.FC<IOverall> = (props) => {
  const {
    dispatch,
    visible,
    onCancel,
  ...
  const handleSubmit = async () => {
    try {
      ...
      return new Promise((resolve: any) => {
        dispatch({
          type: 'purchaseStrategy/addMaterialsPurchaseStrategy',
          payload: values,
          callback: (res: any) => {
            resolve(true);
...
export default connect()(OverallsAdd);
