 ...
 * @constructor
 */
const SubstitutionAdd: React.FC<any> = (props: any) => {
  const {dispatch, visible, onCancel, callbackAddSuccess, matreialProdInfoList} = props;
    ...
    <CrudAddModal
      ...
      onCommit={(values: any) => {
        ...
        return new Promise((resolve) => {
          dispatch({
            type: 'matreialprodSubstitution/addMaterialProdSubstituteInfo',
            payload: values,
            callback: (res: any) => {
              resolve(true);
