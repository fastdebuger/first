...
import ClsInfoListFilter from '@/components/CommonList/ClsInfoListFilter';
 ...
 * @constructor
 */
const ProdInfoAdd: React.FC<any> = (props: any) => {
    ...
    <CrudAddModal
      ...
      onCommit={(values: any) => {
        ...
        return new Promise((resolve) => {
          Object.assign(values, {
            unit_weight: values.unit_weight ? Number(values.unit_weight) : 0,
          });
          dispatch({
