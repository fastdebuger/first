...
import MaterialCategoryEdit from "../Edit";
 ...
 * @constructor
 */
const MaterialCategoryDetail: React.FC<any> = (props) => {
  ...
  const handleDel = () => {
    dispatch({
      type: "materialCategory/deleteMaterialCategory",
      payload: {
...
export default connect()(MaterialCategoryDetail);
