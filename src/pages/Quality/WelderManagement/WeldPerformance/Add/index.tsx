...
import { ErrorCode, WELDER_EQUIPMENT_TYPE_OPTIONS } from "@/common/const";
import { Select, message, DatePicker, InputNumber, Form, AutoComplete } from "antd";
...
const MonitoringMeasuringAdd: React.FC<any> = (props) => {
  const { dispatch, visible, onCancel, callbackSuccess, userList } = props;
    ...
    <CrudAddModal
      ...
      onCommit={(values: any) => {
        ...
        return new Promise((resolve) => {
          ...
          dispatch({
            type: "workLicenseRegister/addWelderPerformance",
            payload: {
              ...values,
