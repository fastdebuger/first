 ...
 * @constructor
 */
const SpecialWorkLedgerEdit: React.FC<any> = (props) => {
  ...
  const getFormColumns = () => {
    const cols = new BasicFormColumns(configColumns)
      ...
      .setFormColumnToDatePicker([
        { value: 'review_date', valueType: 'dateTs', needValueType: 'date' },
        { value: 'next_review_date', valueType: 'dateTs', needValueType: 'date' },
    ...
    <CrudEditModal
      ...
      onCommit={(values: any) => {
        return new Promise((resolve) => {
          dispatch({
            type: "workLicenseRegister/updateSpecialEquipmentWorker",
            payload: {
              ...selectedRecord,
              ...values,
...
export default connect()(SpecialWorkLedgerEdit);
