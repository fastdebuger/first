...
import { message, Select,DatePicker, Form } from "antd";
      ...
      .initFormColumns([
        'year',
        {
          ...
          renderSelfForm: (form: any ) => {
            const handleChange = (date: any, _dateString: any) => {
        ...
        // 'verification_result', // 检定结果
        {
          ...
          renderSelfForm: (form: any) => {
            const handleChange = (value: string) => {
              form.setFieldsValue({ verification_result: value })
            }
            return (
              <Select
                placeholder="请选择检定结果"
  ...
  return (
    <CrudEditModal
      ...
      initialValue={{
        ...
        is_disposable: selectedRecord?.is_disposable + '',
        verification_result: selectedRecord?.verification_result + '',
        professional_class: selectedRecord?.professional_class + '',
        category: selectedRecord?.category + '',
        status: selectedRecord?.status + '',
        affiliated_unit: selectedRecord?.affiliated_unit + '',
        safety_protection: selectedRecord?.safety_protection + '',
      }}
      form={form}
      ...
      onCommit={(values: any) => {
        return new Promise((resolve) => {
          dispatch({
            type: "workLicenseRegister/updateMeasureDevice",
            payload: {
              ...selectedRecord,
              ...values,
