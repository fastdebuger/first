    ...
    return [
      PROP_KEY === 'dep' && selectedRows.length === 1 && (
        <InitiateApproval
          ...
          dispatch={dispatch}
          funcode={'A13'}
          type='workLicenseRegister/deviceStartApproval'
          onSuccess={() => {
  ...
  return (
    <div>
      <BaseCurdSingleTable
        cRef={actionRef}
        rowKey="id"
        tableTitle={formatMessage({id: 'MonitoringMeasuringApproval'})}
        type="workLicenseRegister/getMeasureDeviceApproval"
        exportType="workLicenseRegister/getMeasureDeviceApproval"
        tableColumns={getTableColumns()}
        funcCode={authority+ 'getMeasureDeviceAppr2oval'}
