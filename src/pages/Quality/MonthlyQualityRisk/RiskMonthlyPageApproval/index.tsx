    ...
    return [
      PROP_KEY === 'dep' && selectedRows.length === 1 && (
        <InitiateApproval
          ...
          dispatch={dispatch}
          funcode={'A08'}
          type='workLicenseRegister/riskMonthlyApprovalstartApproval'
          onSuccess={() => {
  ...
  return (
    <div>
      <BaseCurdSingleTable
        cRef={actionRef}
        rowKey="id"
        tableTitle={'月度质量风险评估审批'}
        type="workLicenseRegister/getRiskMonthlyApproval"
        exportType="workLicenseRegister/getRiskMonthlyApproval"
        tableColumns={getTableColumns()}
        funcCode={authority+ 'getRiskMonthlyApprova1l'}
