 ...
 * @constructor
 */
const RiskMonthlyPage: React.FC<any> = (props) => {
      ...
      <Button
        ...
        onClick={() => {
          ...
          Modal.confirm({
            ...
            onOk() {
              dispatch({
                type: "workLicenseRegister/delRiskMonthly",
                payload: {
  ...
  return (
    <div>
      <BaseCurdSingleTable
        ...
        rowKey="h_id"
        tableTitle={'月度质量风险评估'}
        type="workLicenseRegister/queryRiskMonthlyHead"
        exportType="workLicenseRegister/queryRiskMonthlyHead"
        tableColumns={getTableColumns()}
        funcCode={authority + 'queryRiskMonthlyHead'}
...
export default connect()(RiskMonthlyPage);
