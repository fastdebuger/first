...
import ScoringPersonnelAdd from "./Add";
import ScoringPersonnelDetail from "./Detail";
 ...
 * @constructor
 */
const ScoringPersonnelPage: React.FC<any> = (props) => {
...
export default connect()(ScoringPersonnelPage);
