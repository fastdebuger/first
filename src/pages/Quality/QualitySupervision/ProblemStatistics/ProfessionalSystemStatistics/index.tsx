...
import { getQualitySafetyInspectionSystemStatistics } from '@/services/quality/qualityInfo/contractor';
...
const ProfessionalSystemStatistics: React.FC = () => {
  ...
  const fetchData = async (currentDates = dates, currentType = statType) => {
    ...
    try {
      ...
      const res = await getQualitySafetyInspectionSystemStatistics({
