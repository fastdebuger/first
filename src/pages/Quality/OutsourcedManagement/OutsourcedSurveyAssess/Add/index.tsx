 ...
 * @constructor
 */
const PersonnelApplyFormAdd: React.FC<any> = (props) => {
  ...
  const getFormColumns = () => {
    const cols = new BasicFormColumns(configColumns)
      ...
      .setFormColumnToSelfColSpan([
        ...
        { value: 'qualifications', colSpan: 24, labelCol: { span: 8 }, wrapperCol: { span: 16 } },
    ...
    <CrudAddModal
      ...
      onCommit={(values: any) => {
        return new Promise((resolve) => {
          dispatch({
            type: "workLicenseRegister/addExternalLaboratoryEvaluation",
            payload: {
              ...values,
...
export default connect()(PersonnelApplyFormAdd);
