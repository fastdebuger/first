...
import QualityProducedProductsAdd from "./Add";
import QualityProducedProductsDetail from "./Detail";
import QualityProducedProductsEdit from "./Edit";
 ...
 * @constructor
 */
const QualityProducedProductsPage: React.FC<any> = (props) => {
      ...
      <Button
        ...
        onClick={() => {
          ...
          Modal.confirm({
            ...
            onOk() {
              dispatch({
                type: "qualityProducedProducts/deleteQualityProducedProducts",
                payload: {
...
export default connect()(QualityProducedProductsPage);
