...
import QualityTechServiceQualityAdd from "./Add";
import QualityTechServiceQualityDetail from "./Detail";
import QualityTechServiceQualityEdit from "./Edit";
 ...
 * @constructor
 */
const QualityTechServiceQualityPage: React.FC<any> = (props) => {
      ...
      <Button
        ...
        onClick={() => {
          ...
          Modal.confirm({
            ...
            onOk() {
              dispatch({
                type: "qualityTechServiceQuality/deleteQualityTechServiceQuality",
                payload: {
  ...
  return (
    <div>
      ...
      />
      {open && selectedRecord && (
        <QualityTechServiceQualityDetail
          open={open}
          actionRef={actionRef}
...
export default connect()(QualityTechServiceQualityPage);
