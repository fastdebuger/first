...
import QualitySystemOperationAdd from "./Add";
import QualitySystemOperationDetail from "./Detail";
import QualitySystemOperationEdit from "./Edit";
 ...
 * @constructor
 */
const QualitySystemOperationPage: React.FC<any> = (props) => {
      ...
      <Button
        ...
        onClick={() => {
          ...
          Modal.confirm({
            ...
            onOk() {
              dispatch({
                type: "qualitySystemOperation/deleteQualitySystemOperation",
                payload: {
...
export default connect()(QualitySystemOperationPage);
