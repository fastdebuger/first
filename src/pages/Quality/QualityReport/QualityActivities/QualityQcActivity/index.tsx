...
import QualityQcActivityAdd from "./Add";
import QualityQcActivityDetail from "./Detail";
import QualityQcActivityEdit from "./Edit";
 ...
 * @constructor
 */
const QualityQcActivityPage: React.FC<any> = (props) => {
  ...
  const getTableColumns = () => {
    ...
    cols.initTableColumns([
      {
        title: "开展QC小组活动的数量",
        subTitle: "开展QC小组活动的数量",
        dataIndex: "qc_group_count",
        width: 160,
        align: "center",
      ...
      <Button
        ...
        onClick={() => {
          ...
          Modal.confirm({
            ...
            onOk() {
              dispatch({
                type: "qualityQcActivity/deleteQualityQcActivity",
                payload: {
...
export default connect()(QualityQcActivityPage);
