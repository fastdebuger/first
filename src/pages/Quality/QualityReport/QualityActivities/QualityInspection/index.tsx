...
import QualityInspectionAdd from "./Add";
import QualityInspectionDetail from "./Detail";
import QualityInspectionEdit from "./Edit";
 ...
 * @constructor
 */
const QualityInspectionPage: React.FC<any> = (props) => {
      ...
      <Button
        ...
        onClick={() => {
          ...
          Modal.confirm({
            ...
            onOk() {
              dispatch({
                type: "qualityInspection/deleteQualityInspection",
                payload: {
...
export default connect()(QualityInspectionPage);
