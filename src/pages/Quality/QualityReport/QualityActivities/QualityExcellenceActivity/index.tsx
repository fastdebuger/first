...
import QualityExcellenceActivityAdd from "./Add";
import QualityExcellenceActivityDetail from "./Detail";
import QualityExcellenceActivityEdit from "./Edit";
 ...
 * @constructor
 */
const QualityExcellenceActivityPage: React.FC<any> = (props) => {
  ...
  const getTableColumns = () => {
    ...
    cols.initTableColumns([
      {
        title: "compinfo.national_association",
        subTitle: "国家专业协会奖励情况",
      ...
      <Button
        ...
        onClick={() => {
          ...
          Modal.confirm({
            ...
            onOk() {
              dispatch({
                type: "qualityExcellenceActivity/deleteQualityExcellenceActivity",
                payload: {
  ...
  return (
    <div>
      ...
      />
      {open && selectedRecord && (
        <QualityExcellenceActivityDetail
          open={open}
          actionRef={actionRef}
...
export default connect()(QualityExcellenceActivityPage);
