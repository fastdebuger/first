...
import QualityWorkArrangementAdd from "./Add";
import QualityWorkArrangementDetail from "./Detail";
 ...
 * @constructor
 */
const QualityWorkArrangementPage: React.FC<any> = (props) => {
...
export default connect()(QualityWorkArrangementPage);
