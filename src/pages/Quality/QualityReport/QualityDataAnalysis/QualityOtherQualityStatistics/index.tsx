...
import QualityOtherQualityStatisticsAdd from "./Add";
import QualityOtherQualityStatisticsDetail from "./Detail";
import QualityOtherQualityStatisticsEdit from "./Edit";
 ...
 * @constructor
 */
const QualityOtherQualityStatisticsPage: React.FC<any> = (props) => {
      ...
      <Button
        ...
        onClick={() => {
          ...
          Modal.confirm({
            ...
            onOk() {
              dispatch({
                type: "qualityOtherQualityStatistics/deleteQualityOtherQualityStatistics",
                payload: {
  ...
  return (
    <div>
      ...
      />
      {open && selectedRecord && (
        <QualityOtherQualityStatisticsDetail
          open={open}
          actionRef={actionRef}
      ...
      {addVisible && (
        <QualityOtherQualityStatisticsAdd
          visible={addVisible}
      ...
      {editVisible && (
        <QualityOtherQualityStatisticsEdit
          visible={editVisible}
          selectedRecord={selectedRecord}
...
export default connect()(QualityOtherQualityStatisticsPage);
