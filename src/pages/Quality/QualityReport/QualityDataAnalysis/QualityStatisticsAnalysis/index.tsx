...
import QualityStatisticsAnalysisAdd from "./Add";
import QualityStatisticsAnalysisDetail from "./Detail";
 ...
 * @constructor
 */
const QualityStatisticsAnalysisPage: React.FC<any> = (props) => {
  ...
  return (
    <div>
      ...
      />
      {open && selectedRecord && (
        <QualityStatisticsAnalysisDetail
          open={open}
          actionRef={actionRef}
...
export default connect()(QualityStatisticsAnalysisPage);
