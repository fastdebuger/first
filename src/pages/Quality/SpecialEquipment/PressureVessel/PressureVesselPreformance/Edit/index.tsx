...
/**
 * 编辑压力容器制造(组焊、安装改造修理)施工业绩表
 * @param props
 * @constructor
 */
const PressureVesselPreformanceEdit: React.FC<any> = (props) => {
  ...
  const getFormColumns = () => {
    const cols = new BasicFormColumns(configColumns)
      ...
      .setFormColumnToInputNumber([
        ...
        { value: 'single_weight', valueType: 'digit', min: 0 },
        { value: 'design_temperature', valueType: 'digit' },
      ])
  ...
  return (
    <CrudEditModal
      form={form}
      title={"编辑压力容器制造(组焊、安装改造修理)施工业绩表"}
      visible={visible}
      onCancel={onCancel}
      ...
      onCommit={(values = {}) => {
        ...
        return new Promise((resolve) => {
          dispatch({
            type: "pressureVesselPreformance/updateInfo",
            payload: {
              ...selectedRecord,
              ...values
            },
...
export default connect()(PressureVesselPreformanceEdit);
