...
import PVQAStaffNominationEdit from "../Edit";
...
/**
 * 压力容器制造(组焊、安装改造修理)质保体系责任人员推荐表详情
 * @param props
 * @returns
 */
const PVQAStaffNominationDetail: React.FC<any> = (props: any) => {
  ...
  return (
    <>
      <CrudQueryDetailDrawer
        rowKey="unit_name"
        title="压力容器制造(组焊、安装改造修理)质保体系责任人员推荐表"
      ...
      >
        <BaseCurdSingleTable
          cRef={childRef}
          rowKey="id"
          tableTitle="压力容器制造(组焊、安装改造修理)质保体系责任人员推荐表详情"
          moduleCaption="压力容器制造(组焊、安装改造修理)质保体系责任人员推荐表详情"
          type="PVQAStaffNomination/getBody"
          exportType="PVQAStaffNomination/getBody"
          tableDefaultFilter={[
          ...
          funcCode={authority + "-压力容器制造(组焊、安装改造修理)质保体系责任人员推荐表详情"}
        />
      </CrudQueryDetailDrawer>
      {editVisible && (
        <PVQAStaffNominationEdit
          visible={editVisible}
          selectedRecord={selectedRecord}
...
export default connect()(PVQAStaffNominationDetail);
