  ...
  const renderSelectedRowsToolbar = (selectedRows: any[], reloadTable: (filters?: [], noFilters?: []) => void) => {
    ...
    return [
      ...
      hasPermission(authority, '发起审批') && <InitiateApproval
        ...
        dispatch={dispatch}
        funcode={APPROVAL_FUNCODE.PressurePipelineConstructionPerformanceApproval}
        type='pressurePipingPreformance/sendApproval'
        onSuccess={() => {
          if (actionRef.current) {
      ...
      <ViewApproval
        ...
        funcCode={APPROVAL_FUNCODE.PressurePipelineConstructionPerformanceApproval}
        selectedRecord={selectedRecord}
        onSuccess={() => {
          if (actionRef.current) {
            actionRef.current.reloadTable();
  ...
  return (
    <div>
      <BaseCurdSingleTable
        cRef={actionRef}
        rowKey="id"
        tableTitle='压力管道施工业绩表'
        moduleCaption='压力管道施工业绩表'
        type="pressurePipingPreformance/getInfo"
        exportType="pressurePipingPreformance/getInfo"
        tableColumns={getTableColumns()}
        funcCode={authority + "压力管道施工业绩表"}
