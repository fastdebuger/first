...
/**
 * 压力管道安装质量保证体系责任人员推荐表编辑
 * @param props 
 * @returns 
 */
const PPQAStaffNominationEdit: React.FC<any> = (props: any) => {
  ...
  const [applicableScenarios, setApplicableScenarios] = useState<"1" | "2" | null>(() => {
    if (selectedRecord.applicable_scenarios === "装置、场站工程") return "1"
    if (selectedRecord.applicable_scenarios === "长输管道线路工程") return "2"
    return null
  });
    ...
    <CrudEditModal
      ...
      onCommit={(data: any) => {
        ...
        return new Promise((resolve) => {
          ...
          dispatch({
            type: "ppQAStaffNomination/updateInfo",
            payload: {
              ...selectedRecord,
              ...values,
...
export default connect()(PPQAStaffNominationEdit);