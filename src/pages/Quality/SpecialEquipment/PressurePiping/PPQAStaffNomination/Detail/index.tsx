...
/**
 * 压力管道安装质量保证体系责任人员推荐表详情
 * @param props
 * @returns
 */
const ppQAStaffNominationDetail: React.FC<any> = (props: any) => {
    ...
    <>
      ...
      >
        <BaseCurdSingleTable
          cRef={childRef}
          rowKey="id"
          tableTitle="压力管道安装质量保证体系责任人员推荐表详情"
          moduleCaption="压力管道安装质量保证体系责任人员推荐表详情"
          type="ppQAStaffNomination/getBody"
          exportType="ppQAStaffNomination/getBody"
          tableDefaultFilter={[
          ...
          funcCode={authority + "-压力管道安装质量保证体系责任人员推荐表详情"}
        />
      </CrudQueryDetailDrawer>
      {editVisible && (
...
export default connect()(ppQAStaffNominationDetail);
