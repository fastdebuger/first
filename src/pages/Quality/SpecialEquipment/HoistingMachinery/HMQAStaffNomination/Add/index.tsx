...
/**
 * 新增起重机械安装修理质量保证体系责任人员推荐表
 * @param props
 * @returns
 */
const HMQAStaffNominationAdd: React.FC<any> = (props: any) => {
    ...
    <CrudAddModal
      ...
      onCommit={(data: any) => {
        ...
        return new Promise((resolve: any) => {
          ...
          dispatch({
            type: "hmQAStaffNomination/saveInfo",
            payload: {
              ...values,
...
export default connect()(HMQAStaffNominationAdd);
