...
/**
 * 起重机械安装修理质量保证体系责任人员推荐表详情
 * @param props
 * @returns
 */
const HMQAStaffNominationDetail: React.FC<any> = (props: any) => {
    ...
    <>
      ...
      >
        <BaseCurdSingleTable
          cRef={childRef}
          rowKey="id"
          tableTitle="起重机械安装修理质量保证体系责任人员推荐表详情"
          moduleCaption="起重机械安装修理质量保证体系责任人员推荐表详情"
          type="hmQAStaffNomination/getBody"
          exportType="hmQAStaffNomination/getBody"
          tableDefaultFilter={[
          ...
          funcCode={authority + "-起重机械安装修理质量保证体系责任人员推荐表详情"}
        />
      </CrudQueryDetailDrawer>
      {editVisible && (
...
export default connect()(HMQAStaffNominationDetail);
