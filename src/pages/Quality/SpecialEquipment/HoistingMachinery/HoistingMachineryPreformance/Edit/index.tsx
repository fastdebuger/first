 ...
 * @constructor
 */
const HoistingMachineryPreformanceEdit: React.FC<any> = (props) => {
  ...
  const getFormColumns = () => {
    const cols = new BasicFormColumns(configColumns)
      ...
      .setFormColumnToInputNumber([
        ...
        { value: 'height', valueType: 'digit', min: 0 },
        { value: 'rated_load_weight', valueType: 'digit', min: 0 },
        { value: 'span', valueType: 'digit', min: 0 },
      ])
    ...
    <CrudEditModal
      ...
      onCommit={(values = {}) => {
        ...
        return new Promise((resolve) => {
          dispatch({
            type: "hoistingMachineryPreformance/updateInfo",
            payload: {
              ...selectedRecord,
              ...values
            },
...
export default connect()(HoistingMachineryPreformanceEdit);
