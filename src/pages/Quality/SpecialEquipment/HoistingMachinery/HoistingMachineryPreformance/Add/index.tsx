 ...
 * @constructor
 */
const HoistingMachineryPreformanceAdd: React.FC<any> = (props) => {
    ...
    <CrudAddModal
      ...
      onCommit={(values = {}) => {
        ...
        return new Promise((resolve) => {
          dispatch({
            type: "hoistingMachineryPreformance/saveBatch",
            payload: {
...
export default connect()(HoistingMachineryPreformanceAdd);
