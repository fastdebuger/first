 ...
 * @constructor
 */
const PipingComponentsPreformanceEdit: React.FC<any> = (props) => {
    ...
    <CrudEditModal
      ...
      onCommit={(values = {}) => {
        ...
        return new Promise((resolve) => {
          dispatch({
            type: "pipingComponentsPreformance/updateInfo",
            payload: {
              ...selectedRecord,
              ...values
            },
...
export default connect()(PipingComponentsPreformanceEdit);
