 ...
 * @constructor
 */
const PipingComponentsPreformanceAdd: React.FC<any> = (props) => {
  ...
  return (
    <CrudAddModal
      ...
      onCommit={(values = {}) => {
        ...
        values.wbs_code = WBS_CODE;
        return new Promise((resolve) => {
          dispatch({
            type: "pipingComponentsPreformance/saveBatch",
            payload: {
...
export default connect()(PipingComponentsPreformanceAdd);
