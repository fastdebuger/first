...
import PipingComponentsPreformanceAdd from "./Add";
import PipingComponentsPreformanceDetail from "./Detail";
import PipingComponentsPreformanceEdit from "./Edit";
 ...
 * @constructor
 */
const PipingComponentsPreformancePage: React.FC<any> = (props) => {
  ...
  const renderSelectedRowsToolbar = (selectedRows: any[], reloadTable: (filters?: [], noFilters?: []) => void) => {
    ...
    return [
      ...
      hasPermission(authority, '发起审批') && <InitiateApproval
        ...
        dispatch={dispatch}
        funcode={APPROVAL_FUNCODE.PipelineComponentConstructionPerformanceApproval}
        type='pipingComponentsPreformance/sendApproval'
        onSuccess={() => {
          if (actionRef.current) {
      ...
      <ViewApproval
        ...
        funcCode={APPROVAL_FUNCODE.PipelineComponentConstructionPerformanceApproval}
        selectedRecord={selectedRecord}
        onSuccess={() => {
          if (actionRef.current) {
            actionRef.current.reloadTable();
      ...
      <Button
        ...
        onClick={() => {
          ...
          Modal.confirm({
            ...
            onOk() {
              dispatch({
                type: "pipingComponentsPreformance/delInfo",
                payload: {
  ...
  return (
    <div>
      <BaseCurdSingleTable
        cRef={actionRef}
        rowKey="id"
        tableTitle='压力管道元件施工业绩表'
        moduleCaption='压力管道元件施工业绩表'
        type="pipingComponentsPreformance/getInfo"
        exportType="pipingComponentsPreformance/getInfo"
        tableColumns={getTableColumns()}
        funcCode={authority + "压力管道元件施工业绩表"}
      ...
      />
      {open && selectedRecord && (
        <PipingComponentsPreformanceDetail
          open={open}
          actionRef={actionRef}
          selectedRecord={selectedRecord}
          authority={authority}
      ...
      {addVisible && (
        <PipingComponentsPreformanceAdd
          visible={addVisible}
      ...
      {editVisible && (
        <PipingComponentsPreformanceEdit
          visible={editVisible}
          selectedRecord={selectedRecord}
...
export default connect()(PipingComponentsPreformancePage);
