...
/**
 * 新增压力管道元件制造质量保证体系责任人员推荐表
 * @param props
 * @returns
 */
const PCQAStaffNominationnAdd: React.FC<any> = (props: any) => {
    ...
    dispatch({
      ...
      payload: {
        ...
        filter: JSON.stringify([
          { Key: 'special_equip_type', Val: "5", Operator: '=' },
        ])
      },
      callback: (res: any) => {
    ...
    <CrudAddModal
      ...
      onCommit={(data: any) => {
        ...
        return new Promise((resolve: any) => {
          ...
          dispatch({
            type: "pcQAStaffNomination/saveInfo",
            payload: {
              ...values,
...
export default connect()(PCQAStaffNominationnAdd);
