...
import BoilerPreformanceAdd from "./Add";
import BoilerPreformanceDetail from "./Detail";
import BoilerPreformanceEdit from "./Edit";
 ...
 * @constructor
 */
const BoilerPreformancePage: React.FC<any> = (props) => {
  ...
  const renderSelectedRowsToolbar = (selectedRows: any[], reloadTable: (filters?: [], noFilters?: []) => void) => {
    ...
    return [
      ...
      hasPermission(authority, '发起审批') && <InitiateApproval
        ...
        dispatch={dispatch}
        funcode={APPROVAL_FUNCODE.BoilerConstructionPerformanceApproval}
        type='boilerPreformance/sendApproval'
        onSuccess={() => {
          if (actionRef.current) {
      ...
      <ViewApproval
        ...
        funcCode={APPROVAL_FUNCODE.BoilerConstructionPerformanceApproval}
        selectedRecord={selectedRecord}
        onSuccess={() => {
          if (actionRef.current) {
            actionRef.current.reloadTable();
      ...
      <Button
        ...
        onClick={() => {
          ...
          Modal.confirm({
            ...
            onOk() {
              dispatch({
                type: "boilerPreformance/delInfo",
                payload: {
  ...
  return (
    <div>
      <BaseCurdSingleTable
        ...
        rowKey="id"
        tableTitle='锅炉施工业绩表'
        moduleCaption='锅炉施工业绩表'
        type="boilerPreformance/getInfo"
        exportType="boilerPreformance/getInfo"
        tableColumns={getTableColumns()}
        funcCode={authority + "锅炉施工业绩表"}
...
export default connect()(BoilerPreformancePage);
