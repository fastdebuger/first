...
import BoilerQAStaffNominationEdit from "../Edit";
...
/**
 * 锅炉安装改造修理质量保证体系责任人员推荐表详情
 * @param props
 * @returns
 */
const BoilerQAStaffNominationDetail: React.FC<any> = (props: any) => {
    ...
    <>
      ...
      >
        <BaseCurdSingleTable
          cRef={childRef}
          rowKey="id"
          tableTitle="锅炉安装改造修理质量保证体系责任人员推荐表详情"
          moduleCaption="锅炉安装改造修理质量保证体系责任人员推荐表详情"
          type="boilerQAStaffNomination/getBody"
          exportType="boilerQAStaffNomination/getBody"
          tableDefaultFilter={[
          ...
          funcCode={authority + "-锅炉安装改造修理质量保证体系责任人员推荐表详情"}
        />
      </CrudQueryDetailDrawer>
      {editVisible && (
        <BoilerQAStaffNominationEdit
          visible={editVisible}
          selectedRecord={selectedRecord}
...
export default connect()(BoilerQAStaffNominationDetail);
