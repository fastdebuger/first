...
/**
 * 锅炉安装改造修理质量保证体系责任人员推荐表编辑
 * @param props 
 * @returns 
 */
const BoilerQAStaffNominationEdit: React.FC<any> = (props: any) => {
    ...
    <CrudEditModal
      ...
      onCommit={(data: any) => {
        ...
        return new Promise((resolve) => {
          ...
          dispatch({
            type: "boilerQAStaffNomination/updateInfo",
            payload: {
              ...selectedRecord,
              ...values,
...
export default connect()(BoilerQAStaffNominationEdit);