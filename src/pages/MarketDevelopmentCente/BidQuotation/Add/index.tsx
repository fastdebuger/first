 ...
 * @constructor
 */
const BidQuotationAdd: React.FC<any> = (props) => {
  ...
  return (
    <CrudAddModal
      ...
      onCommit={(values: any) => {
        ...
        /**
         * 空值处理：
         * 遍历提交的字段，将值为null或undefined的值改为空字符串。
         */
        for (const key in submitValues) {
          if (!Object.hasOwn(submitValues, key)) continue;
          let element = submitValues[key];
        ...
        return new Promise((resolve) => {
          dispatch({
            type: "bidQuotation/saveBatch",
            payload: {
              Items: JSON.stringify([submitValues]),
            },
            callback: (res: any) => {
              resolve(true);
...
export default connect()(BidQuotationAdd);
