 ...
 * @constructor
 */
const PerformanceLedgerEdit: React.FC<any> = (props) => {
      ...
      .initFormColumns([
        {
          ...
          renderSelfForm: (form: any) => {
            return (
              <SelectIncomeFormItem form={form} record={selectedRecord} />
            )
          }
        },
        'performance_type',
    ...
    <CrudAddModal
      ...
      onCommit={(values: any) => {
        return new Promise((resolve) => {
          dispatch({
            type: "performanceLedger/updateInfo",
            payload: {
              ...selectedRecord,
              ...values
            },
...
export default connect()(PerformanceLedgerEdit);
