...
import FormItemIsDatePicker from "@/pages/Engineering/Month/MonthlyReport/FormItem/FormItemIsDatePicker";
...
interface Item {
  ...
  this_month_complete_workload: number; // 本月完成工作量
  next_month_complete_workload: number; // 下月计划工作量
    ...
    <Form form={form} component={false}>
      <Button size={'small'} type="primary" onClick={() => {
        const newData: any = {
          ...
          this_month_complete_workload: 0, // 本月完成工作量
          next_month_complete_workload: 0, // 下月计划工作量
