...
import { configColumns } from "@/pages/Contract/Expenditure/columns";
 ...
 */
const ContractModal: React.FC<any> = (props: any) => {
        ...
        isVisible && (
          ...
          >
            <BaseCurdSingleTable
              cRef={childRef}
              rowKey="id"
              funcCode={'getcontractNoQuery1'}
              height={'calc(100vh - 340px)'}
              type="personInfo/getcontractNoQuery"
