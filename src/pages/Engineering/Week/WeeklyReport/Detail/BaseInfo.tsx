...
const BaseInfo = (props: any) => {
  ...
  useEffect(() => {
    if (lastWeekRecord && lastWeekRecord.WeeklyReportBase) {
      Object.assign(lastWeekRecord.WeeklyReportBase, {
        project_status: lastWeekRecord.WeeklyReportBase.project_status + ''
      });
      form.setFieldsValue(lastWeekRecord.WeeklyReportBase);
    }
  }, [lastWeekRecord]);
    ...
    >
      <Row gutter={16}>
        ...
        <Col span={6}>
          ...
          >
            <FormItemIsDatePicker disabled needValue={"date"} />
          </Form.Item>
        </Col>
