...
const IncomeAdd: React.FC<Income> = (props) => {
  const {
    dispatch,
    visible,
    onCancel,
  ...
  return (
    <CrudAddModal
      ...
      onCancel={onCancel}
      initialValue={{
        project_location: localStorage.getItem("auth-default-wbsName")
      }}
      ...
      onCommit={(values: any) => {
        ...
        return new Promise((resolve) => {
          dispatch({
            type: 'income/addIncomeInfo',
            payload: {
              ...values,
              // wbs_code: CURR_DEP_CODE
            },
            callback: (res: any) => {
              resolve(true);
              if (res.errCode === ErrorCode.ErrOk) {
