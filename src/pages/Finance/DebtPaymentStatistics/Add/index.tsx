    ...
    <CrudAddModal
      ...
      onCommit={(values: any) => {
        return new Promise((resolve) => {
          // 验证公式1和公式2的计算结果是否相等
          // 公式1: 按照付款比例尚欠款数(22) = 本年具备支付条件金额(13)
          // 公式2: 按照付款比例尚欠款数(22) = 1年以内(23) + 1-3年(24) + 3年以上(25)
          ...
          // 计算公式1和公式2的结果
          const formula2Result = netPayableCurrentYearAvailableValue; // 公式1: 本年具备支付条件金额(13)
          const formula3Result = twoArrearsWithinOneYear + twoArrearsOneToThreeYears + twoArrearsOverThreeYears; // 公式2: 1年以内(23) + 1-3年(24) + 3年以上(25)

          // 判断公式1和公式2是否相等（允许小数点后2位的误差）
          ...
          if (!isEqual) {
            ...
            Modal.error({
              ...
              content: (
                <div>
                  <p style={{ marginBottom: 16, color: '#ff4d4f' }}>按照付款比例尚欠款数(22)的公式2和公式2计算结果不一致，请检查并修改相关字段：</p>
                  <div style={{ marginBottom: 12 }}>
                    <strong>公式1：</strong> 按照付款比例尚欠款数(22) = 本年具备支付条件金额(13)
                    <br />
                  ...
                  <div style={{ marginBottom: 12 }}>
                    <strong>公式2：</strong> 按照付款比例尚欠款数(22) = 1年以内(23) + 1-3年(24) + 3年以上(25)
                    <br />
                    <span style={{ marginLeft: 20 }}>
                  ...
                  <p style={{ marginTop: 16, color: '#ff4d4f' }}>请修改相关字段使公式2和公式2的计算结果一致后再提交。</p>
                </div>
              ),
            });
            resolve(true);
