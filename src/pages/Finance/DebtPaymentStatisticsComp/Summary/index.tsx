...
interface DebtPaymentStatisticsSummaryProps {
  dataSource: any[];
  columns: any[];
}
 ...
 * @returns
 */
const DebtPaymentStatisticsSummary: React.FC<DebtPaymentStatisticsSummaryProps> = (props) => {
...
/**
 * 创建合计函数（用于表格的 summary 属性）
 * @param dataSource 数据源
 * @returns 合计函数
 */
export const createSummaryFn = (dataSource: any[]) => {
  return () => {
    return <DebtPaymentStatisticsSummary dataSource={dataSource} columns={[]} />;
  };
};

export default DebtPaymentStatisticsSummary;
