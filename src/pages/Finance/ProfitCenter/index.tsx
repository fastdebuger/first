...
import ProfitCenterAdd from "./Add";
import ProfitCenterEdit from './Edit';
import ProfitCenterDetail from "./Detail";
 ...
 * @constructor
 */
const ProfitCenterPage: React.FC<any> = (props) => {
      ...
      <Button
        ...
        onClick={() => {
          ...
          Modal.confirm({
            ...
            onOk() {
              dispatch({
                type: "profitCenter/delProfitCenter",
                payload: {
  ...
  return (
    <div>
      <BaseCurdSingleTable
        ...
        importType="profitCenter/importProfitCenter"
...
export default connect()(ProfitCenterPage);
