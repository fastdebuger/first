...
import TechnologyEnvironmentalControlListYearAdd from "./Add";
import TechnologyEnvironmentalControlListYearEdit from "./Edit";
import TechnologyEnvironmentalControlListYearDetail from "./Detail";
 ...
 * @constructor
 */
const TechnologyEnvironmentalControlListYearPage: React.FC<any> = (props: any) => {
    ...
    <div>
      ...
      <BaseHeaderAndBodyTable
        ...
        header={{
          ...
          importType: "technologyHseRiskControlListYear/importTechnologyHseRiskControlListYear2",
        }}
        scan={{
          sort: "form_make_time",
          order: "desc",
        ...
        funcCode={authority + '重要环境因素及控制措施清单'}
        selectedRowsToolbar={() => {
          return {
            headerToolbar: (
              selectedRows?: any[],
        ...
        caption="重要环境因素及控制措施清单"
      />
      {open && (
        <TechnologyEnvironmentalControlListYearDetail
          authority={authority}
          open={open}
      ...
      {addVisible && (
        <TechnologyEnvironmentalControlListYearAdd
          visible={addVisible}
      ...
      {visible && (
        <BaseImportModal
          ...
          startUploadFile={(file: any) => {
            if (actionRef.current) {
              return actionRef.current.importFile(file, 'technologyHseRiskControlListYear_2', () => {
                setVisible(false);
              });
            }
          }}
          downLoadTemplate={() => {
            if (actionRef.current) {
              actionRef.current.downloadImportFile('technologyHseRiskControlListYear_2');
            }
          }}
        />
      )}
...
export default connect()(TechnologyEnvironmentalControlListYearPage);
