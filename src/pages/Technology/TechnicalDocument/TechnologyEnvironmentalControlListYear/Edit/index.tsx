 ...
 * @returns
 */
const TechnologyEnvironmentalControlListYearEdit: React.FC<any> = (props: any) => {
...
export default connect()(TechnologyEnvironmentalControlListYearEdit);
