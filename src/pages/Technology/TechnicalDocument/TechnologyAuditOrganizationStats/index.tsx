...
import TechnologyAuditOrganizationStatsDetail from "./Detail";

/**
 * 施工组织设计审批统计
 * @constructor
 */
const TechnologyAuditOrganizationStats: React.FC<any> = (props) => {
  ...
  return (
    <div>
      <BaseCurdSingleTable
        ...
        funcCode={`${authority}0施工组织设计统计`}
        tableSortOrder={{ sort: 'form_make_time', order: 'desc' }}
        tableDefaultField={{ type_code: '1' }}
      ...
      />
      {open && selectedRecord && (
        <TechnologyAuditOrganizationStatsDetail
          open={open}
          actionRef={actionRef}
...
export default connect()(TechnologyAuditOrganizationStats);
