 ...
 * @constructor
 */
const TechnologyHseRiskControlListEdit: React.FC<any> = (props) => {
    const { dispatch, visible, onCancel, callbackSuccess, selectedRecord, timeType } = props;
            ...
            .initFormColumns([
                {
                    ...
                    renderSelfForm: (form: any) => (
                        <ContractSelectInput
                            ...
                            value={selectedRecord?.contract_out_name}
                            onChange={(record: any) => {
                                form.setFieldsValue({
        ...
        <CrudEditModal
            ...
            onCommit={(values: any) => {
                return new Promise((resolve) => {
                    dispatch({
                        type: "technologyHseRiskControlList/updateTechnologyHseRiskControlList",
                        payload: {
                            ...selectedRecord,
                            ...values,
                            type_code: timeType,
...
export default connect()(TechnologyHseRiskControlListEdit);
