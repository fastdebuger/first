...
import TechnologyAuditSummaryStatsDetail from "./Detail";

/**
 * 项目总结审批统计
 * @constructor
 */
const TechnologyAuditSummaryStats: React.FC<any> = (props) => {
  ...
  const getTableColumns = () => {
    ...
    cols.initTableColumns([
      ...
      'contract_out_name',
      {
        ...
        align: "center",
        render: (text: any, record: any) => {
          // 如果base_data_name有值，显示原值；否则显示工程名称+项目总结
          return text || (record.contract_out_name ? `${record.contract_out_name}项目总结` : '');
        }
      },
      {
  ...
  return (
    <div>
      ...
      />
      {open && selectedRecord && (
        <TechnologyAuditSummaryStatsDetail
          open={open}
          actionRef={actionRef}
...
export default connect()(TechnologyAuditSummaryStats);
