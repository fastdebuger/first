 ...
 * @returns
 */
const TechnologyHseRiskControlListYearDetail: React.FC<any> = (props: any) => {
...
export default connect()(TechnologyHseRiskControlListYearDetail);
