 ...
 * @constructor
 */
const TechnologyAuditOrganization: React.FC<any> = (props) => {
  ...
  const renderSelectedRowsToolbar = (selectedRows: any[], reloadTable: (filters?: [], noFilters?: []) => void) => {
    ...
    let reportName = '';
    if (selectedRows[0]?.contract_say_price < 50000000) {
      reportName = 'Co';
    }  else {
      reportName = 'Co-Company';
    }
...
export default connect()(TechnologyAuditOrganization);
