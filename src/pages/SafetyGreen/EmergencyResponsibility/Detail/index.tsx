...
import EmergencyPlanDetails from "../AddEmergencyPlan";
 ...
 * @constructor
 */
const EmergencyResponsibilityDetail: React.FC<any> = (props) => {
    ...
    <>
      ...
      >
        <EmergencyPlanDetails
          record={{
            form_no: selectedRecord?.plan_config_id
          }}
          authority={authority}
          isDetail={true}
        />
...
export default connect()(EmergencyResponsibilityDetail);
