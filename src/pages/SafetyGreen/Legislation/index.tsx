...
import LegislationAdd from "./Add";
import LegislationDetail from "./Detail";
 ...
 * @constructor
 */
const LegislationPage: React.FC<any> = (props) => {
  ...
  return (
    <div>
      <BaseCurdSingleTable
        ...
        rowKey="id"
        tableTitle='处置规程'
        type="legislation/getInfo"
        exportType="legislation/getInfo"
...
export default connect()(LegislationPage);
