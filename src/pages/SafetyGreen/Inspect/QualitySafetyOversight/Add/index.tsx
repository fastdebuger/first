...
const QualitySafetyInspectionAdd: React.FC<any> = (props) => {
  ...
  // 根据责任单位归属获取具体违章单位名称数据和验证人数据
  useEffect(() => {
    if (responsibleUnit) {
      fetchViolationUnitData(responsibleUnit);
      // fetchVerifyObsCodeData(responsibleUnit);
    }
  ...
  const getFormColumns = () => {
    ...
    const cols = new BasicFormColumns(configColumns)
      .initFormColumns([
        ...
        'system_belong',
        {
          ...
          renderSelfForm: (form: any) => {
            const onChange = (val) => {
              form.setFieldsValue({ verify_user_code: val })
            }
            return (
      ...
      .needToDisabled([
        ...
        { value: 'question_category', disabled: getFieldDisabled(problemCategory, 'question_category') },
      ...
      .setFormColumnToSelect([
        ...
        // {
        //   value: 'verify_user_code',
        //   valueAlias: 'value',
        //   name: 'name',
        //   valueType: 'select',
        //   data: verifyObsCodeOptions,
        // },
        {
      ...
      .setSplitGroupFormColumns([
        ...
        {
          title: 'HSE问题归类',
          columns: ['safety_factor1', 'safety_factor2', 'operation_behavior_ids', 'question_category'],
        },
        {
          title: '责任归属',
          ...
          dispatch({
            ...
            payload: {
              ...
              items: JSON.stringify([{
                id: values.operation_behavior_ids,
                number: 0
              }]),
            },
            callback: (res: any) => {
