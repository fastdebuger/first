...
import HrCourseMaterialAdd from "./Add";
import HrCourseMaterialDetail from "./Detail";
import HrCourseMaterialEdit from "./Edit";

/**
 * 课程资料
 * @constructor
 */
const HrCourseMaterialPage: React.FC<any> = (props) => {
  ...
  const getTableColumns = () => {
    ...
    .setTableColumnToDatePicker([
      ...
      {value: 'create_tz', valueType: 'dateTs', format: 'YYYY-MM-DD'},
      {value: 'modify_ts', valueType: 'dateTs', format: 'YYYY-MM-DD'},
      {value: 'modify_tz', valueType: 'dateTs', format: 'YYYY-MM-DD'},
    ])
    .needToExport([
      "id",
      "course_id",
...
export default connect()(HrCourseMaterialPage);
