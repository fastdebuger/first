...
import HrLecturerAdd from "./Add";
import HrLecturerDetail from "./Detail";
import HrLecturerEdit from "./Edit";

/**
 * 讲师表
 * @constructor
 */
const HrLecturerPage: React.FC<any> = (props) => {
  ...
  return (
    <div>
      <BaseCurdSingleTable
        ...
        rowKey="id"
        tableTitle='讲师表'
        type="hrLecturer/queryHrLecturer"
        importType="hrLecturer/importHrLecturer"
...
export default connect()(HrLecturerPage);
