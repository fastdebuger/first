...
import AddHrCourseMaterial from "@/pages/HR/HrCourse/Detail/AddHrCourseMaterial";
 ...
 * @constructor
 */
const HrCourseDetail: React.FC<any> = (props) => {
    ...
    <>
      ...
      >
         <Tabs defaultActiveKey="1">
          <Tabs.TabPane tab="课程资料" key="1">
            <AddHrCourseMaterial selectedCourseItem={selectedRecord}/>
          </Tabs.TabPane>
        </Tabs>
      </CrudQueryDetailDrawer>
      {editVisible && (
...
export default connect()(HrCourseDetail);
