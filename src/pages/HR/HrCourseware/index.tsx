...
import HrCoursewareAdd from "./Add";
import HrCoursewareDetail from "./Detail";
import HrCoursewareEdit from "./Edit";

/**
 * 课件表
 * @constructor
 */
const HrCoursewarePage: React.FC<any> = (props) => {
      ...
      <Button
        ...
        onClick={() => {
          ...
          Modal.confirm({
            ...
            onOk() {
              dispatch({
                type: "hrCourseware/delHrCourseware",
                payload: {
  ...
  return (
    <div>
      <BaseCurdSingleTable
        ...
        rowKey="id"
        tableTitle='课件表'
        type="hrCourseware/queryHrCourseware"
        importType="hrCourseware/importHrCourseware"
...
export default connect()(HrCoursewarePage);
