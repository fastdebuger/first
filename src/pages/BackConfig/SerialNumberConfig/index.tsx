...
import SerialNumberConfigAdd from "./Add";
 ...
 * @constructor
 */
const SerialNumberConfigPage: React.FC<any> = (props) => {
  ...
  return (
    <div>
      <BaseCurdSingleTable
        ...
        rowKey="id"
        tableTitle='单据号配置'
        type="serialNumberConfig/getSerialNumberConfig"
        exportType="serialNumberConfig/getSerialNumberConfig"
...
export default connect()(SerialNumberConfigPage);
