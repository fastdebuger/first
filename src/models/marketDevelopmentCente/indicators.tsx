...
import {
  ...
  updateInfo,  
  delInfo,  
} from "@/services/marketDevelopmentCente/indicators";

/**
 * 定义state类型
 */
export interface IIndicatorsStateType {}

/**
 * 定义Model数据类型
 */
export interface IIndicatorsModelType {
  namespace: string;
  state: IIndicatorsStateType;
  effects: {
    getInfo: Effect;
    saveInfo: Effect;
    updateInfo: Effect;
 ...
 * 市场开发指标
 */
const IndicatorsModel: IIndicatorsModelType = {
