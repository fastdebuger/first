 ...
 * 定义state类型
 */
export interface ILegislationStateType {}

/**
 * 定义Model数据类型
 */
export interface ILegislationModelType {
  namespace: string;
  state: ILegislationStateType;
  effects: {
    getInfo: Effect;
    saveInfo: Effect;
    updateInfo: Effect;
 ...
 * 处置规程
 */
const LegislationModel: ILegislationModelType = {
...
export default LegislationModel;
