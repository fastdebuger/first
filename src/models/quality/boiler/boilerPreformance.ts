...
import {
  ...
  delInfo,
  sendApproval
} from "@/services/quality/boiler/boilerPreformance";

/**
 * 定义state类型
 */
export interface IBoilerPreformanceStateType { }

/**
 * 定义Model数据类型
 */
export interface IBoilerPreformanceModelType {
  namespace: string;
  state: IBoilerPreformanceStateType;
  effects: {
    getInfo: Effect;
    saveBatch: Effect;
    updateInfo: Effect;
 ...
 * 锅炉施工业绩表
 */
const BoilerPreformanceModel: IBoilerPreformanceModelType = {
  namespace: "boilerPreformance",
...
export default BoilerPreformanceModel;
