const Client = require('ssh2-sftp-client');// 连接118服务器 并进行文件夹相关操作
...
/**
 * 主程序
 * @param localFolderPath 本地dist文件夹路径
 * @param remoteFolderPath 远程lunix的dist文件夹路径
 * @returns {Promise<void>}
 */
async function main(localFolderPath, remoteFolderPath) {
...
// 参数一：本地dist文件夹路径
// 参数二：远程lunix的dist文件夹路径
main('./dist', 'C:\\nginx-1.19.10\\port6099');
// main('./dist', 'C:\\nginx-1.19.10\\html');
